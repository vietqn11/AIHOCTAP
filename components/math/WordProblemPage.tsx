...
import { PageProps, WordProblem, WordProblemEvaluation, WordProblemHint } from '../../types';
import { generateWordProblem, evaluateWordProblemAnswer, provideWordProblemHint } from '../../services/geminiService';
import Spinner from '../Spinner';
import { LightbulbIcon } from '../icons/Icons';

const WordProblemsPage = ({ context }: PageProps) => {
    const { lesson } = context;
    const [problem, setProblem] = useState<WordProblem | null>(null);
    const [userAnswer, setUserAnswer] = useState('');
    const [evaluation, setEvaluation] = useState<WordProblemEvaluation | null>(null);
    const [hint, setHint] = useState<WordProblemHint | null>(null);
