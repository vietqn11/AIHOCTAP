...
import { PageProps, HandwrittenEvaluation } from '../../types';
import { evaluateHandwriting } from '../../services/geminiService';
import Spinner from '../Spinner';
import { ArtIcon } from '../icons/Icons';

const HandwritingEvaluationPage = (props: PageProps) => {
    const [image, setImage] = useState<string | null>(null);
    const [imageBase64, setImageBase64] = useState<string | null>(null);
    const [result, setResult] = useState<HandwrittenEvaluation | null>(null);
