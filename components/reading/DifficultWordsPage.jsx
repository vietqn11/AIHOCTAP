...
import { identifyAndExplainDifficultWords, generateTextToSpeech } from '../../services/geminiService.js';
import { playBase64Audio } from '../../utils/audioUtils.js';
import Spinner from '../Spinner.jsx';
import { SpeakerIcon } from '../icons/Icons.jsx';

const DifficultWordsPage = ({ context }) => {
    ...
    const handleListenToWord = async (word) => {
