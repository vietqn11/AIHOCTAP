...
import { summarizeRolePlay } from '../../services/geminiService.js';
import { submitRolePlayResult } from '../../services/googleSheetsService.js';
import Spinner from '../Spinner.jsx';

const RolePlayResultPage = ({ navigate, context, user }) => {
    ...
    useEffect(() => {
        const getFeedbackAndSave = async () => {
            try {
                ...
                const userHistory = history.filter((line, index) => {
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                ...
                <ul className="space-y-4">
                    {history.map((line, index) => {
                        const originalLineInfo = script.script.find((l) => l.line === line.original);
