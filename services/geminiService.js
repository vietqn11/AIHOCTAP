...
export const evaluateReading = async (passageText, audioBase64, mimeType, durationInSeconds) => {
...
export const generateReadingComprehensionQuestions = async (passageText) => {
...
export const identifyAndExplainDifficultWords = async (passageText) => {
...
export const evaluateWriting = async (text) => {
...
export const evaluateHandwriting = async (imageBase64) => {
...
export const generateWritingOutline = async (topic) => {
...
export const generateWordProblem = async (lessonTitle) => {
...
export const evaluateWordProblemAnswer = async (problemText, userAnswer) => {
...
export const provideWordProblemHint = async (problemText) => {
...
export const evaluateRolePlayReading = async (scriptLine, audioBase64, mimeType) => {
...
export const generateSimpleChatResponse = async (subject, question, persona) => {
...
export const analyzeImageForNature = async (imageBase64) => {
...
export const evaluateEthicalChoice = async (scenario, choice) => {
...
export const generateArtIdea = async (topic) => {
...
export const summarizeRolePlay = async (scriptTitle, history) => {
