...
export const submitWritingResult = (user, topic, writtenText, evaluation) => {
...
export const submitReadingResult = (user, passageTitle, evaluation) => {
    const formData = new FormData();
...
export const submitMathResult = (user, activity, score) => {
    const formData = new FormData();
...
export const submitRolePlayResult = (user, scriptTitle, feedback) => {
    const formData = new FormData();
