export const Page = {
    Login: 'Login',
    Home: 'Home',
    ReadingHome: 'ReadingHome',
    PassageSelection: 'PassageSelection',
    DifficultWords: 'DifficultWords',
    Reading: 'Reading',
    Result: 'Result',
    RolePlayScriptSelection: 'RolePlayScriptSelection',
    RolePlayReading: 'RolePlayReading',
    RolePlayResult: 'RolePlayResult',
    WritingHome: 'WritingHome',
    WritingTopicSelection: 'WritingTopicSelection',
    WritingAssistance: 'WritingAssistance',
    WritingResult: 'WritingResult',
    HandwritingEvaluation: 'HandwritingEvaluation',
    WritingOutline: 'WritingOutline',
    WriteFromImage: 'WriteFromImage',
    MathHome: 'MathHome',
    MentalMath: 'MentalMath',
    WordProblemLessonSelection: 'WordProblemLessonSelection',
    WordProblems: 'WordProblems',
    NatureHome: 'NatureHome',
    EthicsHome: 'EthicsHome',
    ArtHome: 'ArtHome',
    MusicHome: 'MusicHome',
    PEHome: 'PEHome',
    ExperienceHome: 'ExperienceHome',
    InformaticsHome: 'InformaticsHome',
    NatureAndSociety: 'NatureAndSociety',
    Ethics: 'Ethics',
    Art: 'Art',
    Music: 'Music',
    PE: 'PE',
    ...
    WritingEvaluationResult: 'WritingEvaluationResult',
...
export const MATH_LESSONS_VOL1 = [
